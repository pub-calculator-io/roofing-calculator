...
Version: 1.0.0
Author: Roofing Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Roofing Calculator by www.calculator.io";

function display_calcio_ci_roofing_calculator(){
    $page = 'index.html';
    return '<h2><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48">Roofing Calculator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_roofing_calculator_iframe"></iframe></div>';
}


add_shortcode( 'ci_roofing_calculator', 'display_calcio_ci_roofing_calculator' );